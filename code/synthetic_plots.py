...
for i in range(10):
    with open(saved_root + "/latent_R2_seed{}.pkl".format(i+1), "rb") as f:
        res = pickle.load(f)
...
if __name__ == "__main__":
    ...
    with open("res/lorenz_dca/latent_R2_{}.pkl".format(N), "rb") as f:
        res = pickle.load(f)
